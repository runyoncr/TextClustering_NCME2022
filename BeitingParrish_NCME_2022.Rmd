...
Many of the packages require that the data be pre-process and formatted in to a <a href="https://en.wikipedia.org/wiki/Document-term_matrix" target="_blank">document-term matrix.</a>
...
# unusual for the math items; omitting from demonstration

suppressPackageStartupMessages(library(qdap))


freq_terms(tm::removeWords(essays$essay, stopwords("english")))
# more pre-processing would be beneficial
